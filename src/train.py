...
tf.app.flags.DEFINE_integer("code_vocab_size", 15000, "Natural language vocabulary size.")
tf.app.flags.DEFINE_integer("nl_vocab_size", 15000, "Identifier vocabulary size.")
tf.app.flags.DEFINE_string("data_dir", "../data/csharp", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "../data/csharp/train", "Training directory.")
tf.app.flags.DEFINE_string("test_dir", "../data/csharp/test", "Testing directory")
tf.app.flags.DEFINE_string("model_dir", "../data/csharp/model", "model directory")
tf.app.flags.DEFINE_string("lang", "csharp", "code language")
...
def test_bleu():
    ...
    with tf.Session() as sess:
        ...
        f = open(FLAGS.data_dir + '/evaluate.json', 'w')
        f.write('BLUE: {:.2f} in {} samples'.format(total_score / counter * 10, counter) + '\n')
        for result in results:
            f.write(json.dumps(result) + '\n')
        f.close()
